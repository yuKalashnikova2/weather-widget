...
<template>
  <div :class="['card__weather', styleBackground(Math.round(dataWeather?.main.temp))]">
    ...
    <div class="card__weather-info">
      ...
      <div class="card__weather-info-descr">
        ...
        <div class="card__weather-info-icon">
          ...
          <img :src="`https://openweathermap.org/img/wn/${dataWeather?.weather[0].icon}.png`" :alt="dataWeather?.weather[0].icon" />
        </div>
      </div>
    </div>
  </div>
...
.card__weather {
  ...
  overflow: hidden;
  &_background-red {
    background: linear-gradient(322deg, rgba(249, 57, 57, 0.20) 13.99%, rgba(255, 98, 98, 0.20) 104.25%), linear-gradient(273deg, #F94545 -7%, rgba(255, 80, 80, 0.65) 102.49%), url('https://www.erv.ru/upload/medialibrary/587/ww7gich3fbgmb19hqv6z82r8ithpch0x/%D0%9B%D0%B5%D0%B3%D0%B5%D0%BD%D0%B4%D0%B0%D1%80%D0%BD%D1%8B%D0%B9%20%D0%9A%D0%BE%D0%BB%D0%B8%D0%B7%D0%B5%D0%B9%20%D0%BD%D0%B0%20%D0%B2%D0%BE%D1%81%D1%85%D0%BE%D0%B4%D0%B5%20%D1%81%D0%BE%D0%BB%D0%BD%D1%86%D0%B0,%20%D0%A0%D0%B8%D0%BC,%20%D0%98%D1%82%D0%B0%D0%BB%D0%B8%D1%8F.jpg'), lightgray -3px -19.573px / 102.469% 100% no-repeat;
  }
  &_background-yellow {
    background: linear-gradient(325deg, rgba(239, 188, 56, 0.14) 14.05%, rgba(250, 186, 24, 0.20) 100%), linear-gradient(271deg, #FDD368 -4.18%, #F8B70F -4.17%, rgba(222, 194, 123, 0.60) 110.03%), url('https://www.erv.ru/upload/medialibrary/587/ww7gich3fbgmb19hqv6z82r8ithpch0x/%D0%9B%D0%B5%D0%B3%D0%B5%D0%BD%D0%B4%D0%B0%D1%80%D0%BD%D1%8B%D0%B9%20%D0%9A%D0%BE%D0%BB%D0%B8%D0%B7%D0%B5%D0%B9%20%D0%BD%D0%B0%20%D0%B2%D0%BE%D1%81%D1%85%D0%BE%D0%B4%D0%B5%20%D1%81%D0%BE%D0%BB%D0%BD%D1%86%D0%B0,%20%D0%A0%D0%B8%D0%BC,%20%D0%98%D1%82%D0%B0%D0%BB%D0%B8%D1%8F.jpg'), lightgray 50% / cover no-repeat;
  }
  &-title {
    flex-grow: 1;
    margin-top: 24px;
